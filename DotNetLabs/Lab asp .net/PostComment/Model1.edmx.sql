...
-- --------------------------------------------------
-- Date Created: 04/28/2020 15:59:13
-- Generated from EDMX file: C:\Users\dghiuzan\source\repos\DotNetLabs\DotNetLabs\Lab asp .net\PostComment\Model1.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[Posts] (
    ...
    [DatePost] nvarchar(max)  NOT NULL
);
GO
...
CREATE TABLE [dbo].[Comments] (
    ...
    [Author] nvarchar(max)  NOT NULL,
    [DateComment] nvarchar(max)  NOT NULL,
